...
public class RoutineController : Controller
{
    ...
    public Daily SelectedDaily { get => selectedDaily;}

    public Activity SelectedActivity { get => selectedActivity;}
    ...
    public async Task<List<Training>> GetTrainings()
    {
        if (trainings != null)
        {
            ...
            Task<ResponseDTO> getTrainingsInfo = webConnectionManager.PostAndReturnRequiredTrainings(new TrainingIDsOutDTO(trainingIds));
    ...
    private async void CheckCompletedActivities()
    {
        ...
        {
            Task<ResponseDTO> updateCompletedActivities = webConnectionManager.UpdateCompletedDailyActivities(new CompletedDailyActivitiesOutDTO(selectedDaily, selectedRoutine));
    ...
    {
        training.TrainingImage = localFilesService.GetTrainingImageByName(training.ImageUrl);
        training.TrainingVideo = localFilesService.GetTrainingVideoByName(training.VideoUrl);
