...
public class RegisterClientDTO : OutDTO
{
    ...
    public RegisterClientDTO(string email, string passTest, string nationality, string username, string firstname, string lastname, string dni, string phone, string sex, string icon, string avatar)
    {
        this.email = email;
